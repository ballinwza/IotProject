        ...
        <Slide easing="ease" {...fadeProperties}>
          <div className="each-slide">
            ...
            <div className="slideContent-1">
              ...
              <p className="mainText">
                บริษัทฯได้เป็นส่วนหนึ่งของงานที่ปรึกษาการใช้งานรังสีในภาคอุตสาหกรรม งานวิจัย ตลอดจนการติดตั้งและใช้งานเครื่องมือ <br />
          ...
          <div className="each-slide">
            ...
            <div className="slideContent-2">
              <h1>Products</h1>
              <p className="mainText">
                บริษัทฯได้เป็นส่วนหนึ่งของงานที่ปรึกษาการใช้งานรังสีในภาคอุตสาหกรรม <br />
                งานวิจัย ตลอดจนการติดตั้งและใช้งานเครื่องมือวัดรังสี ตั้งแต่ขนาดเล็ก  <br/>
